...
/***/ "./src/EmailModuleEditor/index.js":
/*!****************************************!*\
  !*** ./src/EmailModuleEditor/index.js ***!
  \****************************************/
/*! no static exports found */
...
var EmailModuleEditor = (_temp2 = _class = function (_PureComponent) {
    _inherits(EmailModuleEditor, _PureComponent);

    function EmailModuleEditor() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, EmailModuleEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EmailModuleEditor.__proto__ || Object.getPrototypeOf(EmailModuleEditor)).call.apply(_ref, [this].concat(args))), _this), _this.render = function () {
            var _this$props = _this.props,
                label = _this$props.label,
                className = _this$props.className,
                identifier = _this$props.identifier,
                options = _this$props.options,
                renderHelpIcon = _this$props.renderHelpIcon;

            var disabled = (0, _plowJs.$get)("options.disabled", _this.props);
                    ...
                    _react2.default.createElement(
                        _reactUiComponents.Button,
                        {
                            ...
                            onClick: function onClick() {
                                _this.props.renderSecondaryInspector("IFRAME", function () {
                                    return _react2.default.createElement("iframe", {
                                        style: { height: "100%", width: "100%", border: 0 },
                                        name: name || "email-module",
                                        src: src.indexOf("ClientEval:") === 0 ? eval(src.replace("ClientEval:", "")) : src
                                    });
                                });
                            },
                            style: "lighter"
                        },
                        icon ? _react2.default.createElement(_reactUiComponents.Icon, { icon: icon, padded: "right" }) : null,
...
var _EmailModuleEditor = __webpack_require__(/*! ./EmailModuleEditor */ "./src/EmailModuleEditor/index.js");

var _EmailModuleEditor2 = _interopRequireDefault(_EmailModuleEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)("Garagist.Mautic:EmailModuleEditor", {}, function (globalRegistry) {
    ...
    editorsRegistry.set("Garagist.Mautic/Inspector/Editors/EmailModule", {
        component: _EmailModuleEditor2.default,
        hasOwnLabel: true
    });
});
